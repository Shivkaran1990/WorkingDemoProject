...
<div class="container-fluid text-left">    
  <div class="row content">
	...
	<p><b>Basic Information</b></p>
     ...
     <img id="pic" style="height:151px;width:151px;" />
	  <p id="userName">Name : </p>
	   <p id="email_id">Email : </p>
	    <p id="gender">Sex : </p>
		 <p id="link">Link For Account : </p>	 
    </div>    
...
$(document).ready(function(){
    ...
    $("#lgoogle").click(function(){	   
		...
		var scopes="https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/plus.me https://www.googleapis.com/auth/plus.circles.read";
	...
	function testing(token)
		{
		$.ajax({
		url:'https://www.googleapis.com/plus/v1/people?query=denmark&key=5?access_token='+token,
		data:null,
